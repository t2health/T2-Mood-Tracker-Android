...
public class ScaleActivity extends BaseActivity implements OnClickListener {
	...
	public void onClick(View v) {
		switch(v.getId()) {
			...
			case R.id.saveButton:
				dbAdapter.open();
				currentScale.max_label = ((TextView)this.findViewById(R.id.maxLabel)).getText().toString();
				currentScale.min_label = ((TextView)this.findViewById(R.id.minLabel)).getText().toString();
				currentScale.save();
