...
public class PasswordActivity extends Activity implements android.view.View.OnClickListener {
		...
		switch(CURRENT_INTERFACE) {
			case INTERFACE_CONFIRM_PASSWORD:
				...
				// Passwords do not match, show confirm dialog again.
					...
					this.showInterface(INTERFACE_CONFIRM_PASSWORD);
					((TextView)viewConfirmPassword.findViewById(R.id.text1)).setText(R.string.activity_password_confirm_message_error);
					return;
			...
			case INTERFACE_NEW_PASSWORD2:
				...
				// Passwords do not match, show password1 dialog.
					...
					this.showInterface(INTERFACE_NEW_PASSWORD1);
					((TextView)viewSetPassword1.findViewById(R.id.text1)).setText(R.string.activity_password_new_message1_error);
					return;
				}
		}
	}
	...
	private void showInterface(int id) {
		...
		switch(id) {
			case INTERFACE_CONFIRM_PASSWORD:
				((TextView)vi.findViewById(R.id.text1)).setText(R.string.activity_password_confirm_message);
				((Button)vi.findViewById(R.id.positiveButton)).setText(R.string.activity_password_unlock);
				this.setContentView(vi);
				break;
				
			case INTERFACE_NEW_PASSWORD1:
				((TextView)vi.findViewById(R.id.text1)).setText(R.string.activity_password_new_message1);
				((Button)vi.findViewById(R.id.positiveButton)).setText(R.string.activity_password_next);
				this.setContentView(vi);
				break;
				
			case INTERFACE_NEW_PASSWORD2:
				((TextView)vi.findViewById(R.id.text1)).setText(R.string.activity_password_new_message2);
				((Button)vi.findViewById(R.id.positiveButton)).setText(R.string.activity_password_set);
				this.setContentView(vi);
				break;
		}
