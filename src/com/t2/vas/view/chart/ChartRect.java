 ...
 */
public final class ChartRect implements Parcelable {
    public int left;
    public int top;
    public int right;
    public int bottom;
     ...
     */
    public ChartRect(int left, int top, int right, int bottom) {
        this.left = left;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
    ...
    public ChartRect(int left, int top, int right, int bottom, Double value) {
        this.left = left;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
    ...
    public ChartRect(Rect r, Double value) {
        left = r.left;
        top = r.top;
        right = r.right;
        bottom = r.bottom;
    ...
    public ChartRect(ChartRect r, Double value) {
    	left = r.left;
        top = r.top;
        right = r.right;
        bottom = r.bottom;
